...
function Soru7din() {
  ...
  const images = Array.from({ length: 37 }, ( _, index) => ({
    path: `/images/din7images/image${index + 1}.png`,
    number: index + 1
  }));
  ...
  const Counter = () => {
   ...
   return (
    <div style={{margin:"auto 1rem"}}>
        <div style={{margin:"auto 1rem"}} >
        <h2 style={{backgroundColor:"lightblue", padding:"1rem" ,color:"white", margin:"auto"}} >7.SINIF DİN KÜLTÜRÜ SORULAR</h2>
        </div>
      ...
      <div style={{margin:"auto 1rem", border:"2px solid lightblue"}} >
        <div className="flex-column d-flex align-items-center  ">
          <div style={{padding:".5rem",border:"3px solid grey",width:"fit-content",margin:"1rem auto",borderRadius:"8px",boxShadow:"0px 0px 5px",alignItems:"center" , backgroundColor: imageBackgrounds[randomIndex] }}>
            <img  src={`/images/din7images/image${randomIndex + 1}.png`} alt={`Random Image`} />
            <div >
